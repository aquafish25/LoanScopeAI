...
# Model Classes (same as in model.py)
...
def load_model_and_pipeline():
    ...
    try:
        ...
        with open('configs/feature_pipeline/feature_pipeline.pkl', 'rb') as f:
        ...
        model.load_state_dict(torch.load('models/loan_model.pth', map_location='cpu'))
        model.eval()
